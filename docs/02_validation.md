...
─────┼──────────────────────────────────────────────────────────────────
   1 │ Chinstrap           46.4          18.6             190      3450
```
...
```
4×3 Matrix{Float64}:
 0.00261561   0.0916023    0.120051
 0.320226     0.347009     0.000507166
 0.0611628    0.0400795    1.09444e-5
 0.000744236  0.000791391  3.64717e-6
```
...
3-element Vector{Float64}:
 3.8126557687601516e-8
 1.008232743417928e-6
 2.430311585000284e-15
```
